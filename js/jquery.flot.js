        ...
        function drawSeriesLines(series) {
            function plotLine(data, offset, axisx, axisy) {
                ...
                for (var i = 0; i < data.length; ++i) {
                    ...
                    if (series.lines.smooth) {
                        // from http://en.wikipedia.org/wiki/Low-pass_filter#Digital_simulation
                        var alpha = series.lines.smooth;
                        cur = [cur[0], (alpha) * prev[1] + (1-alpha) * cur[1]];
                    }
